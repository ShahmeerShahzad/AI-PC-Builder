...
st.markdown("**Developed by: Shahmeer Shahzad | FA24-BCS-103 | CUI Lahore**")

st.write("Configure your parameters below. The inference engine will evaluate the knowledge base, resolve hardware conflicts, and map out the required logic.")
